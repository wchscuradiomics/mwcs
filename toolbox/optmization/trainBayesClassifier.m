% Train a binary classifier using Bayes.
% [trainedClassifier, validationResult] = trainBayesClassifier(DS,labels,cvp,...
%   distributionNames,width,kernel,prior,isFoldResultNeeded)
% 
