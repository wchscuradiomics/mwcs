% r = parallelRf(TRN,TST,li,maxNumSplits,minLeafSize,minParentSize,numVariablesToSample,...
%   splitCriterion,predictorSelection,numLearningCycles,prior) train a RF classifier
% and return its hyperparameters & performance.
% 
...
%  r is {maxNumSplits,minLeafSize,minParentSize,numVariablesToSample,...
